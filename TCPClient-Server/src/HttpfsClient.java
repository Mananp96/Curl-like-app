...
public class HttpfsClient {
	...
	public HttpfsClient(String host, int port, String query,String content2, ArrayList<String> headers) {
	...
	public static void main(String args[]) throws IOException, URISyntaxException {
		...
		HttpfsClient client2 = new HttpfsClient(host,port,query.substring(1),content, headers);
		client2.sendRequest();
	}
}
